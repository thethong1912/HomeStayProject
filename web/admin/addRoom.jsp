<%-- 
    Document   : addRoom
    Created on : Aug 24, 2019, 2:32:52 PM
    Author     : The Thong
--%>
            ...
            <div id="content-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <form action="/HomeStayProject/MainRoomController" method="POST" >
                        Room Name : <input type="text" name="txtRoomName" value="${param.txtRoomName}" required="true"/>

                        <br/>
                        Room Detail : <input type="text" name="txtRoomDetail" value="${param.txtRoomDetail}" required="true"/>

                        <br/>
                        Room Price : <input type="number" name="txtRoomPrice" value="${param.txtSerPrice}" min="1" required="true"/>

                        <br/>
                        Room Quantity : <input type="number" name="txtRoomQuantity" value="${param.txtSerQuantity}" min="1" max="999" required="true"/>

                        <br/>
                        Room Image : <input type="text" name="txtRoomImage" value="${param.txtSerImage}" required="true"/>

                        <br/>
                        Room Type : 
                        <select name="cbTypeRoom">
